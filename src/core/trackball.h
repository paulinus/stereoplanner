...
class Trackball {
 public:
  ...
  Eigen::Vector3f CameraCoordinates(const Eigen::Vector3f &world_coords) const;
  Eigen::Vector3f WorldCoordinates(const Eigen::Vector3f &cam_coords) const;
  Eigen::Vector3f Project(const Eigen::Vector3f &q) const;
